      ...
      <section className="seccion">
        ...
        <div className="seccion-grid">
          <FoodCard
            ...
            onVerDetalle={() => navigate("/boletos", { state: { producto: "Refresco Grande" } })}
          />
          <FoodCard
            title="Agua Natural"
            Price="35"
            ...
            onVerDetalle={() => navigate("/boletos", { state: { producto: "Agua Natural" } })}
          />
        </div>
      ...
      <section className="seccion">
        ...
        <div className="seccion-grid">
          <FoodCard
            ...
            onVerDetalle={() => navigate("/boletos", { state: { producto: "Palomitas Grandes" } })}
          />
          <FoodCard
            title="Chocolates"
            Price="45"
            image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTyIKiUsnvSraQW0SRz-Q0b66AmiKkyz8iSIA&s"
            onVerDetalle={() => navigate("/boletos", { state: { producto: "Chocolates" } })}
          />
        </div>
      </section>
    </>
