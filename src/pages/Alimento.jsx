      ...
      <section className="seccion">
        ...
        <div className="seccion-grid">
          <FoodCard
            ...
            onVerDetalle={() => navigate("/alimentos/detalle/refresco-grande")}
          />
          <FoodCard
            title="Agua Natural"
            Price="35"
            ...
            onVerDetalle={() => navigate("/alimentos/detalle/agua-natural")}
          />
        </div>
      ...
      <section className="seccion">
        ...
        <div className="seccion-grid">
          <FoodCard
            ...
            onVerDetalle={() => navigate("/alimentos/detalle/palomitas-grandes")}
          />
          <FoodCard
            title="Chocolates"
            Price="45"
            image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTyIKiUsnvSraQW0SRz-Q0b66AmiKkyz8iSIA&s"
            onVerDetalle={() => navigate("/alimentos/detalle/chocolates")}
          />
        </div>
      </section>
    </>
